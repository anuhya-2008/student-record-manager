...
function saveMarks() {
    ...
    s.grade = calculateGrade(Number(percentage));
...
function loadBranches() {
    ...
    [...new Set(students.map(s => s.branch))].forEach(branch => {
        box.innerHTML += `<button class="branchBtn" onclick="filterBranch('${branch}')">${branch}</button>`;
    });
}
